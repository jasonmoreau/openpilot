...
class opParams:
  def __init__(self):
    ...
    self.fork_params = {'camera_offset': Param(-0.04 if TICI else 0.06, NUMBER, 'Your camera offset to use in lane_planner.py\n'
                        ...
                        'cruise_offset': Param(1.0, NUMBER, 'Multiplier to adjust OP long cruise speed\n'
                                                            'Helpful if your car shifts to low gears and high RPMs on the highway', live=True)}
