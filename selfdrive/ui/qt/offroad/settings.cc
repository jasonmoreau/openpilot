...
TogglesPanel::TogglesPanel(QWidget *parent) : QWidget(parent) {
  ...
  toggles.append(new ParamControl("OpenpilotLongEnabledToggle",
                                  ...
                                  "Enable openpilot longitudinal control (if compatible). This is handy if you have a Comma Pedal and/or SmartDSU and want to toggle between stock ACC or openpilot ACC. Reboot required to enable or disable.",
                                  "../assets/offroad/icon_openpilot.png",
                                  this));
